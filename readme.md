...
Este projeto foi desenvolvido em Python para classificar o perfil de consumo de água de imóveis e exibir alertas educativos aos moradores.

funcionalidade

O programa solicita ao usuário duas informações:
1. O tipo de imóvel: comercial, casa ou apartamento.
2. O consumo mensal de água em metros cúbicos (m³).
Depois, o programa analisa as informações e apresenta uma mensagem de acordo com as regras abaixo:
...
Conta no GitHub para publicar o repositório.
